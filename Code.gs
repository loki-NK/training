var AUTH_ID = 'AUTH ID';                                                                           // put your plivo auth id here
var AUTH_TOKEN = 'Auth Token';                                                    // put your plivo auth token her         
...
    }
    
    var condition_task = row['SHOULD_SEND'];
    if(condition_task === true){
